...
public class Benchmark {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for (int i = 0; i < IMPORTLIST.length; i++) {
            ...
            // Messungen der Laufzeit des Algorithmus
            tempResult.append(String.format("%f%s", FloydWarshall.algorithmRtm(g, source, target), DELIMETER));
            // Messung für Distance
            tempResult.append(String.format("%s%s", FloydWarshall.distance, DELIMETER));
            // Darstellung des kürzesten Weges
            List<Node> shortestRouteFW = FloydWarshall.getShortestPath(g, source, target);
