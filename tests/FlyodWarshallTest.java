...
public class FlyodWarshallTest {
    ...
    private static FloydWarshall expected, result;
	...
	public void testCompute() throws IndexOutOfBoundsException, Exception {
		...
		// Create
		 expected = new FloydWarshall();
		 result = new FloydWarshall();
		// init
		 init();
		// Start
	...
	public void testDijkstra() throws IndexOutOfBoundsException, Exception{
		...
		// init
		 init();
		// Start
		expected.getShortestPath(graph03.getNode("Paderborn"), graph03.getNode("Walsrode"));
		result.getShortestPath(graph03.getNode("Paderborn"), graph03.getNode("Walsrode"));
		// Proof
		assertEquals(expected.toString(), result.toString());
    ...
    public void negGetPath() throws Exception {
		graph03 = GraphReader.openFile(new File("src/graph/subwerkzeuge/graph03.gka"));
		init();
		expected.getShortestPath(graph03.getNode("Exist"), graph03.getNode("Exist"));
        result.getShortestPath(graph03.getNode("Exist"), graph03.getNode("Exist"));
        assertEquals(expected.toString(), result.toString());
    ...
    public void negNode() throws Exception {
		...
		result = new FloydWarshall();
		init();
		expected.getShortestPath(graph03.getNode("Paderborn"), graph03.getNode("DoesNotExist"));
        result.getShortestPath(graph03.getNode("Paderborn"), graph03.getNode("DoesNotExist"));
        assertEquals(expected.toString(), result.toString());
    ...
    public void testBIG() throws Exception {
		FloydWarshall expected = new FloydWarshall(), result = new FloydWarshall();
